...
const developers = ["555084382621270125","id"]
...
client.on('message', message => {
      ...
      .addBlankField(true)
      .addField('Mmebers Count',`${message.guild.memberCount}`)
...
if(message.author.id !== '555084382621270125') return message.reply('**الامر خاص بـ صاحب البوت وشكرا**');
          client.destroy();
